 ...
 * Name: echo_request.cc
 * Description:
 *   This file contains implementation of EchoRequest class.
 ******************************************************************/
...
namespace echoer {
  unsigned char *
  EchoRequest::Serialize(uint32_t *length_ptr) {
    uint32_t totalLength = 0;
    uint32_t length0 = 0;
    unsigned char *data0 = name_.Serialize(&length0);
    if (length0 <= 127) {
  ...
  void
  EchoRequest::Deserialize(unsigned char *data, uint32_t length) {
