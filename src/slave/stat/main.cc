...
main(int argc, char **argv) {
  try {
    ...
    ::org::labcrypto::hottentot::runtime::Logger::GetOut() << "FENCE SLAVE STAT CLIENT" << std::endl;
    ...
    try {
      ...
      if (dynamic_cast< ::org::labcrypto::hottentot::runtime::proxy::Proxy*>(proxy)->IsServerAlive()) {
        ...
        ::org::labcrypto::hottentot::runtime::Logger::GetOut() << "ERROR: Fence slave node is not available." << std::endl;
      }
      //=============================================
