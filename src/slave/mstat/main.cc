...
void PrintHelpMessage() {
  ...
  std::cout << "  ./fence-slave-mstatus [ARGUMENTS]" << std::endl;
  std::cout << std::endl;
...
main(int argc, char **argv) {
  try {
    ...
    ::org::labcrypto::hottentot::runtime::Logger::GetOut() << "FENCE SLAVE MESSAGE STATUS CLIENT" << std::endl;
    ...
    if (!::org::labcrypto::hottentot::runtime::Configuration::Exists("i", "id")) {
      ::org::labcrypto::hottentot::runtime::Logger::GetError() << "ERROR: Message id is not specified." << std::endl;
      PrintHelpMessage();
    }
    ...
    uint64_t id = ::org::labcrypto::hottentot::runtime::Configuration::AsUInt64("i", "id");
    ...
    try {
      ...
      if (dynamic_cast< ::org::labcrypto::hottentot::runtime::proxy::Proxy*>(proxy)->IsServerAlive()) {
        ::org::labcrypto::hottentot::UInt64 idVar(id);
        ::org::labcrypto::hottentot::UInt16 status;
        proxy->GetStatus(idVar, status);
        if (status.GetValue() == ::org::labcrypto::fence::kMessageStatus___Unknown) {
          ::org::labcrypto::hottentot::runtime::Logger::GetOut() << "Status: UNKNOWN" << std::endl;
        } else if (status.GetValue() == ::org::labcrypto::fence::kMessageStatus___EnqueuedForTransmission) {
          ::org::labcrypto::hottentot::runtime::Logger::GetOut() << "Status: ENQUEUED FOR TRANSMISSION" << std::endl;
        } else if (status.GetValue() == ::org::labcrypto::fence::kMessageStatus___Transmitted) {
          ::org::labcrypto::hottentot::runtime::Logger::GetOut() << "Status: TRANSMITTED" << std::endl;
        } else if (status.GetValue() == ::org::labcrypto::fence::kMessageStatus___TransmissionFailed) {
          ::org::labcrypto::hottentot::runtime::Logger::GetOut() << "Status: TRANSMISSION FAILED" << std::endl;
        } else {
          std::stringstream ss;
      ...
      ::org::labcrypto::hottentot::runtime::Logger::GetError() << "ERROR: " << e.what() << std::endl;
      ::org::labcrypto::fence::proxy::FenceServiceProxyBuilder::Destroy(proxy);
      if (::org::labcrypto::hottentot::runtime::Configuration::Verbose()) {
        ::org::labcrypto::hottentot::runtime::Logger::GetOut() << "Proxy object is destroyed." << std::endl;
      }
