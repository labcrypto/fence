...
namespace transport {
  ...
  TransportMessage::Serialize(uint32_t *length_ptr) {
    ...
    uint32_t length2 = 0;
    unsigned char *data2 = relId_.Serialize(&length2);
    if (length2 <= 127) {
    ...
    uint32_t length3 = 0;
    unsigned char *data3 = relLabel_.Serialize(&length3);
    if (length3 <= 127) {
    ...
    uint32_t length4 = 0;
    unsigned char *data4 = label_.Serialize(&length4);
    if (length4 <= 127) {
    ...
    uint32_t length5 = 0;
    unsigned char *data5 = content_.Serialize(&length5);
    if (length5 <= 127) {
