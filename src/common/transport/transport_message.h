...
namespace transport {
  ...
  public:
    ...
    inline ::naeem::hottentot::runtime::types::UInt64 GetSlaveId() const {
      return slaveId_;
    }
    inline void SetSlaveId(::naeem::hottentot::runtime::types::UInt64 slaveId) {
      slaveId_ = slaveId;
    }
  ...
  private:
    ...
    ::naeem::hottentot::runtime::types::UInt64 slaveId_;
