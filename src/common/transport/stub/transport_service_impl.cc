...
namespace transport {
  ...
  void
  TransportServiceImpl::RetrieveSlaveMessages(::naeem::hottentot::runtime::types::UInt64 &slaveId, ::naeem::hottentot::runtime::types::List< ::ir::ntnaeem::gate::transport::TransportMessage> &out) {
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
