 ...
 * Name: transport_status.cc
 * Description:
 *   This file contains implementation of TransportStatus class.
 ******************************************************************/
...
namespace transport {
  unsigned char *
  TransportStatus::Serialize(uint32_t *length_ptr) {
  ...
  void
  TransportStatus::Deserialize(unsigned char *data, uint32_t length) {
