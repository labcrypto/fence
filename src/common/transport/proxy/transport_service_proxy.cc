...
namespace proxy {
  ...
  void
  TransportServiceProxy::RetrieveSlaveMessages(::naeem::hottentot::runtime::types::UInt64 &slaveId, ::naeem::hottentot::runtime::types::List< ::ir::ntnaeem::gate::transport::TransportMessage> &out) {
    /*
     * Make request object
     */
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
    ...
    ::naeem::hottentot::runtime::Request request;
    request.SetServiceId(3529562908);
    request.SetMethodId(2230953147);
    request.SetType(::naeem::hottentot::runtime::Request::InvokeStateless);
    /*
     * Serialize arguments
     */
