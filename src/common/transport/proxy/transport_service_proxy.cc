...
namespace proxy {
  ...
  void
  TransportServiceProxy::Ack(::naeem::hottentot::runtime::types::List< ::naeem::hottentot::runtime::types::UInt32> &masterMIds) {
    /*
     * Make request object
     */
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
    ...
    ::naeem::hottentot::runtime::Request request;
    request.SetServiceId(3529562908);
    request.SetMethodId(2798878501);
    request.SetType(::naeem::hottentot::runtime::Request::InvokeStateless);
    /*
     * Serialize arguments
     */
  ...
  void
  TransportServiceProxy::GetStatus(::naeem::hottentot::runtime::types::UInt32 &masterMId, ::ir::ntnaeem::gate::transport::TransportMessageStatus &out) {
    /*
     * Make request object
     */
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
    ...
    ::naeem::hottentot::runtime::Request request;
    request.SetServiceId(3529562908);
    request.SetMethodId(2180351276);
    request.SetType(::naeem::hottentot::runtime::Request::InvokeStateless);
    /*
     * Serialize arguments
     */
