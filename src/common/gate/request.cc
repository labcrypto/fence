 ...
 * Name: request.cc
 * Description:
 *   This file contains implementation of Request class.
 ******************************************************************/
...
namespace gate {
  unsigned char *
  Request::Serialize(uint32_t *length_ptr) {
    ...
    uint32_t length1 = 0;
    unsigned char *data1 = label_.Serialize(&length1);
    if (length1 <= 127) {
    ...
    uint32_t length2 = 0;
    unsigned char *data2 = content_.Serialize(&length2);
    if (length2 <= 127) {
  ...
  void
  Request::Deserialize(unsigned char *data, uint32_t length) {
