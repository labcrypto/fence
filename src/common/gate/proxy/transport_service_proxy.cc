...
namespace proxy {
  void
  TransportServiceProxy::Send(::naeem::hottentot::runtime::types::List< ::ir::ntnaeem::gate::Message> &parcels, ::naeem::hottentot::runtime::types::List< ::naeem::hottentot::runtime::types::UInt32> &out) {
    /*
     * Make request object
     */
    ...
    request.SetServiceId(1269507307);
    request.SetMethodId(3339907255);
    ...
    /*
     * Serialization of argument 'parcels'
     */
    serializedDataLength = 0;
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
      ::naeem::hottentot::runtime::Logger::GetOut() << "Serializing argument parcels ..." << std::endl;
    }
    serializedData = parcels.Serialize(&serializedDataLength);
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
      ::naeem::hottentot::runtime::Logger::GetOut() << "parcels is serialized." << std::endl;
    }
  ...
  void
  TransportServiceProxy::Receive(::naeem::hottentot::runtime::types::List< ::ir::ntnaeem::gate::Message> &out) {
    /*
     * Make request object
     */
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
    ...
    ::naeem::hottentot::runtime::Request request;
    request.SetServiceId(1269507307);
    request.SetMethodId(3765050486);
    request.SetType(::naeem::hottentot::runtime::Request::InvokeStateless);
    /*
     * Serialize arguments
     */
  ...
  void
  TransportServiceProxy::GetMessageStatus(::naeem::hottentot::runtime::types::UInt32 &id, ::naeem::hottentot::runtime::types::UInt32 &out) {
    /*
     * Make request object
     */
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
    ...
    ::naeem::hottentot::runtime::Request request;
    request.SetServiceId(1269507307);
    request.SetMethodId(4252051591);
    request.SetType(::naeem::hottentot::runtime::Request::InvokeStateless);
    /*
     * Serialize arguments
     */
