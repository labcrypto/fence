...
namespace proxy {
  void
  GateServiceProxy::EnqueueMessage(::ir::ntnaeem::gate::Message &message, ::naeem::hottentot::runtime::types::UInt32 &out) {
    /*
     * Make request object
     */
    ...
    request.SetMethodId(1213808204);
  ...
  void
  GateServiceProxy::GetMessageStatus(::naeem::hottentot::runtime::types::UInt32 &id, ::ir::ntnaeem::gate::Status &out) {
    /*
     * Make request object
     */
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
    ...
    ::naeem::hottentot::runtime::Request request;
    request.SetServiceId(58024360);
    request.SetMethodId(4214326115);
    request.SetType(::naeem::hottentot::runtime::Request::InvokeStateless);
    /*
     * Serialize arguments
     */
