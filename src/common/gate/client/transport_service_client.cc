...
main(int argc, char **argv) {
  try {
    ...
    ::ir::ntnaeem::gate::TransportService *proxy = 
        ::ir::ntnaeem::gate::proxy::TransportServiceProxyBuilder::Create("127.0.0.1", 2000);
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
      ::naeem::hottentot::runtime::Logger::GetOut() << "Proxy object is created." << std::endl;
    }
    // TODO Do whatever you want with proxy objects.
    ::ir::ntnaeem::gate::proxy::TransportServiceProxyBuilder::Destroy(proxy);
    if (::naeem::hottentot::runtime::Configuration::Verbose()) {
