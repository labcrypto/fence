...
namespace master {
  ...
  public:
    ...
    virtual void Ack(::naeem::hottentot::runtime::types::List< ::naeem::hottentot::runtime::types::UInt32> &masterMIds);
    virtual void GetStatus(::naeem::hottentot::runtime::types::UInt32 &masterMId, ::ir::ntnaeem::gate::transport::TransportMessageStatus &out);
  };
