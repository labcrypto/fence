...
void PrintHelpMessage() {
  ...
  std::cout << "  ./fence-master-pop [ARGUMENTS]" << std::endl;
  std::cout << std::endl;
...
main(int argc, char **argv) {
  try {
    ...
    ::org::labcrypto::hottentot::runtime::Logger::GetOut() << "FENCE MASTER POP CLIENT" << std::endl;
    ...
    if (!::org::labcrypto::hottentot::runtime::Configuration::Exists("l", "label")) {
      ::org::labcrypto::hottentot::runtime::Logger::GetError() << 
        "ERROR: Message label is not specified." << std::endl;
      PrintHelpMessage();
      exit(1);
    }
    ...
    try {
      ...
      if (dynamic_cast< ::org::labcrypto::hottentot::runtime::proxy::Proxy*>(proxy)->IsServerAlive()) {
        ...
        ::org::labcrypto::hottentot::runtime::Logger::GetOut() << "ERROR: ::org::labcrypto::fence::Fence is not available." << std::endl;
      }
      //=============================================
