...
void PrintHelpMessage() {
  ...
  std::cout << "  ./fence-master-sack [ARGUMENTS]" << std::endl;
  std::cout << std::endl;
...
main(int argc, char **argv) {
  try {
    ...
    ::org::labcrypto::hottentot::runtime::Logger::GetOut() << "FENCE MASTER S-ACK CLIENT" << std::endl;
    ...
    try {
      ...
      if (dynamic_cast< ::org::labcrypto::hottentot::runtime::proxy::Proxy*>(proxy)->IsServerAlive()) {
        ::org::labcrypto::hottentot::UInt64 *id = 
          new ::org::labcrypto::hottentot::UInt64(messageId);
        ::org::labcrypto::hottentot::List< ::org::labcrypto::hottentot::UInt64> ids;
        ids.Add(id);
        proxy->Ack(ids);
