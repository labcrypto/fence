...
void PrintHelpMessage() {
  ...
  std::cout << "  ./fence-master-enq [ARGUMENTS]" << std::endl;
  std::cout << std::endl;
...
main(int argc, char **argv) {
  try {
    ...
    ::org::labcrypto::hottentot::runtime::Logger::GetOut() << "FENCE MASTER ENQUEUE CLIENT" << std::endl;
    ...
    if (!::org::labcrypto::hottentot::runtime::Configuration::Exists("l", "label")) {
      ::org::labcrypto::hottentot::runtime::Logger::GetError() << 
        "ERROR: Master label is not specified." << std::endl;
      PrintHelpMessage();
      ::org::labcrypto::hottentot::runtime::Logger::Shutdown();
      exit(1);
    }
    ...
    if (!::org::labcrypto::hottentot::runtime::Configuration::Exists("r", "related-id")) {
      ::org::labcrypto::hottentot::runtime::Logger::GetError() << 
        "ERROR: Related message id is not specified." << std::endl;
      PrintHelpMessage();
      ::org::labcrypto::hottentot::runtime::Logger::Shutdown();
      exit(1);
    }
    if (!::org::labcrypto::hottentot::runtime::Configuration::HasValue("r", "related-id")) {
      ::org::labcrypto::hottentot::runtime::Logger::GetError() << 
        "ERROR: Related message id is not specified." << std::endl;
      PrintHelpMessage();
      ::org::labcrypto::hottentot::runtime::Logger::Shutdown();
    ...
    if (::org::labcrypto::hottentot::runtime::Configuration::Exists("i", "input") &&
      ...
      ::org::labcrypto::hottentot::runtime::Logger::GetError() << 
        "ERROR: Input file is not specified." << std::endl;
      PrintHelpMessage();
      ::org::labcrypto::hottentot::runtime::Logger::Shutdown();
      exit(1);
    }
    ...
    uint64_t relatedId = ::org::labcrypto::hottentot::runtime::Configuration::AsUInt64("r", "related-id");
    ...
    try {
      ...
      if (dynamic_cast< ::org::labcrypto::hottentot::runtime::proxy::Proxy*>(proxy)->IsServerAlive()) {
        ...
        ::org::labcrypto::hottentot::UInt64 relatedIdVar(relatedId);
